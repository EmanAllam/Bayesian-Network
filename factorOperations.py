...
def joinFactors(factors: List[Factor]):
    ...
    You should calculate the set of unconditioned variables and conditioned  done
    ...
    factors are the same, since they come from the same BayesNet.                  done
    ...
    #step 1 conditioned and unconditioned
    for i in Factors_list:
        #print(i.unconditionedVariables())
        #print("before")
        #print(unconditioned)
        unconditioned.extend(i.unconditionedVariables())
        #print("after")
        #print(unconditioned)
        #unconditioned.append(unconditioned_1)
        conditioned.extend( j for j in i.conditionedVariables() if j not in conditioned)
        #do not repeat:
       
        #conditioned.append(j)        
    new_con=[]
    ...
    for i in newfactor.getAllPossibleAssignmentDicts():
        ...
        for j in Factors_list:
            probability = probability*j.getProbability(i)
            
        newfactor.setProbability(i, probability)
    ...
    def eliminate(factor: Factor, eliminationVariable: str):
      ...
      # eliminationVariable must be an unconditioned variable in factor.
        ...
        for i in newfactor.getAllPossibleAssignmentDicts():
             ...
             for j in variableDomainsDict[eliminationVariable]:
